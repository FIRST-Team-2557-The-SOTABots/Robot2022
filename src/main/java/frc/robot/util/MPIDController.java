...
*/
public class MPIDController implements Sendable, AutoCloseable {
   ...
   */
  public MPIDController(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
   ...
   */
  public MPIDController(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
  ...
  public boolean atSetpoint() {
    ...
    if (m_continuous) {
      ...
      positionError = tempError > m_maximumInput / 2 ?
  ...
  public double calculate(double measurement) {
    ...
    if (m_continuous) {
        ...
        m_positionError = tempError > m_maximumInput / 2 ?
            tempError - m_maximumInput :
            tempError;
        assert(Math.abs(m_positionError) <= m_maximumInput / 2); // TODO: get rid of if no error
